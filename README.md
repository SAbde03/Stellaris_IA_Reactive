...
Ce projet implementé par p5.js est une simulaion de jeux qui conciste à piloter un vaisseaux spaciale à l'aide d'un ensemble de comportement declenchés soit par le mouvement de la sourie ou par l'appuie sur des touches de clavier.
